...
class BaseDataset(Dataset):
    ...
    def _apply_scaling(
        self, image, scale_factor, width, height, bg_color, scale_width=True
    ):
    ...
    def _apply_rotation(self, image, bg_color):
        ...
        background = Image.new(
            "RGBA", rotated_image.size, (bg_color[0], bg_color[1], bg_color[2], 255)
        )
        ...
        new_points = np.float32(
            [
                [
                    ...
                    random.uniform(0, height * perspective_scale),
                ],
                [
    ...
    def augment_image(
        ...
        if random.random() < scale_prob:
            ...
            if random.random() < 0.5:
                ...
                image = self._apply_scaling(
                    image, scale_factor, width, height, bg_color, scale_width=True
                )
                image = self._apply_scaling(
                    image, scale_factor, width, height, bg_color, scale_width=False
                )
            else:
                ...
                image = self._apply_scaling(
                    image, scale_factor_w, width, height, bg_color, scale_width=True
                )
                image = self._apply_scaling(
                    image, scale_factor_h, width, height, bg_color, scale_width=False
                )
